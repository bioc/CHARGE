...
#' A SummarizedExperiment from a publicly available RNA-seq data set. The data set is GSE55504 and contains 16 samples where 8 are euploid or chromosome 21 and the other 8 are trisomy.
#'
